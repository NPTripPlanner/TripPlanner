    ...
    return (
      <React.Fragment>
        {handleDialog(DialogTypes.Login, "Login", <LoginForm />, [
          <Link key="1" onClick={() => dispatch(Signup())}>
            I dont have an account
          </Link>,
          <Link key="2" onClick={() => dispatch(ForgotPassword())}>
            Forgot password?
          </Link>,
        ])(dialogName)}
        {handleDialog(DialogTypes.Singup, "Signup", <SignupForm />, [
          <Link key="1" onClick={() => dispatch(Login())}>
            I have an account
          </Link>,
        ])(dialogName)}
        {handleDialog(
          DialogTypes.ForgotPass,
          "Forgot Password",
          <ForgotPassForm />,
          [
            <Link key="1" onClick={() => dispatch(Login())}>
            ...
            <Link key="2" onClick={() => dispatch(Signup())}>
              I dont have an account
            </Link>,
          ]
        )(dialogName)}
